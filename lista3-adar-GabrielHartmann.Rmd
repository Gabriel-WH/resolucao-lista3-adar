...
Porque a função `as.data.frame` do pacote `raster` com o argumento `na.rm` como `TRUE` faz com que as linhas sem valores (valor = `NA`) sejam removidas.
- - -
